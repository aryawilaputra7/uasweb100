        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    @error('merk_mobil')<small style="color:yellow">{{$message}}</small>@enderror
                </div>
                ...
                <div class="col-lg-10">
                    ...
                    @error('plat_mobil')<small style="color:yellow">{{$message}}</small>@enderror
                </div>
                ...
                <div class="col-lg-10">
                    ...
                    @error('warna_mobil')<small style="color:yellow">{{$message}}</small>@enderror
                </div>
                ...
                <div class="col-lg-10">
                    ...
                    @error('tahun_mobil')<small style="color:yellow">{{$message}}</small>@enderror
                </div>
            </div>
